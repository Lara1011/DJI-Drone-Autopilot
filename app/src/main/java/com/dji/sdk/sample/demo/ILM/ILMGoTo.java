...
public class ILMGoTo implements ILM_GoTo {
    private int mode = 0;
    ...
    public ILMGoTo(ILMWaypoints ilmWaypoints) {
        this.ilmWaypoints = ilmWaypoints;
        if(ModuleVerificationUtil.isFlightControllerAvailable()){
            flightController = DJISampleApplication.getAircraftInstance().getFlightController();
        }
    }
    public ILMGoTo(double lat, double lon, double alt, double speed, double radius, double minDistance) {
        this.lat = lat;
        this.lon = lon;
        this.alt = alt;
        this.speed = speed;
